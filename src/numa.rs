...
#[cfg(target_os = "linux")]
use libc::{sched_getcpu, cpu_set_t, CPU_ZERO, CPU_SET, sched_setaffinity};
...
impl NumaPageAllocator {
    ...
    pub fn alloc_page(&self, page_id: PageId, flags: PageFlags, preferred_node: Option<NumaNode>) -> Box<Page> {
